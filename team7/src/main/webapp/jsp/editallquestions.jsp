...
<head>
<meta charset="UTF-8">
<link href="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
...
<body>
 <%
 	...
 	if(session.getAttribute("username")==null){
 		response.sendRedirect("../jsp/editallquestions.jsp");
 	}
 %>
 <header>
